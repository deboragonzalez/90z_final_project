...
m1 <- lm(logfaminc16 ~ hgc_mother_1979 + hgc_age25 + faminc_1979 + sex_1979, 
             data = dataset1, 
...
stargazer(m1, type = "html", digits = 3,
              ...
              covariate.labels=c("Mother's Educ", "Educ by Age 25", "Fam. Income 1979", "Sex: Female"),
...
m2 <- lm(logfaminc16 ~ hgc_mother_1979 + hgc_father_1979 + hgc_age25 + faminc_1979 + sex_1979, 
             data = dataset1, 
             weights = sampweight_1979)
